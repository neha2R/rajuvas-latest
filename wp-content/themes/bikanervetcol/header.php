...
<link href="<?php  echo bloginfo('template_url');?>/css/media.css?v=12345" type="text/css" rel="stylesheet">
     ...
     <div id="header">
           <div class="top-a menu-inter">
        	...
        	<div id="header-top">
             ...
             <form action="/bikaner/" method="GET">
             <input class="search"  type="search" name="s" placeholder="Search Pages and People...">
                ...
                <div id="header-top-left">
                  <div id="logo" class="wow bounceInLeft" data-wow-delay="0.6s"><a href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php  echo bloginfo('template_url');?>/images/Logo2.png" width="130" height="120" alt="CVAS"></a>
                </div>
                  
 <h4 class="logo-title-vetcol wow bounceInLeft" data-wow-delay="0.4s">College of Veterinary and Animal Science<br>Bikaner</h4>
                </div>
