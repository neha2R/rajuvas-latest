            ...
            <div id="marque-text">
            	...
            	<div id="introduction">
                 <div id="topbar-intro">
                    ...
                    <?php if(get_field('introduction_block',1398)) {
		  		while(has_sub_field('introduction_block',1398)) {
				$img_url=get_sub_field('image',1398);?>
...
<div class="items">
             <img src="<?php echo $img_url['url']; ?>" alt="<?php echo $img_url['alt']; ?>" height="231">
</div>
