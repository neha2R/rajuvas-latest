...
function sharbh_widgets_init() {
	...
	register_sidebar( array(
		...
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widget-title heading hidden">',
		'after_title' => '</h3>',
	) );
	...
	register_sidebar( array(
		'name' => __( 'Footer Widget Area1', 'Rajuvas' ),
	...
	register_sidebar( array(
		'name' => __( 'News Widget Area', 'Rajuvas' ),
		'id' => 'news-widget-area',
		'description' => __( 'Appears in the News section of the site.', 'Rajuvas' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
