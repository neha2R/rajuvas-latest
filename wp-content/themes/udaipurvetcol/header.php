	...
	<div id="wrapper">
     ...
     <div id="header">
        	...
        	<div id="header-top">
             ...
             <form action="/udaipur/" method="GET">
             <input class="search"  type="search" name="s" placeholder="Search Pages and People...">
                ...
                <div id="header-top-left">
                  <div id="logo" class="wow bounceInLeft" data-wow-delay="0.6s"><a href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php  echo bloginfo('template_url');?>/images/header-logo.png" alt="CVAS Udaipur"></a>
                </div>
                  
                <h4 class="logo-title-vetcol wow bounceInLeft" data-wow-delay="0.4s">College of Veterinary and Animal Science<br>Navania, Vallabhnagar, Udaipur</h4>
                </div>
